...
function new_scripts() { // INICIA A FUNÇÂO
    $template_url = get_template_directory_uri(); // PEGA O CAMINHO DO TEMA
  
    //Main Style
    wp_enqueue_style( 'roda', $template_url . '/css/roda.css', array(), null, false); // ADD CSS
    //Main Style
	wp_enqueue_style( 'modelo3', $template_url . '/css/modelo3.css', array(), null, false); // ADD CSS
	//Main Style
	wp_enqueue_style( 'coaching-de-aprendizado', $template_url . '/css/coaching.css', array(), null, false); // ADD CSS
	//Main Style
	wp_enqueue_style( 'coaching-de-aprendizado-gear', $template_url . '/css/coaching-gear.css', array(), null, false); // ADD CSS
	//Main Style
...
add_action( 'wp_enqueue_scripts', 'new_scripts', 1 ); // DISPARA A FUNÇÃO COM OS SCRIPTS ADICIONADOS
